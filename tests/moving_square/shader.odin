...
/*
    ...
    Overview:
    =========
    Shader program: 'square':
        Get shader desc: square_shader_desc(sg.query_backend())
        Vertex Shader: vs
        Fragment Shader: fs
        Attributes:
            ATTR_square_position => 0
            ATTR_square_color0 => 1
    Bindings:
...
square_shader_desc :: proc (backend: sg.Backend) -> sg.Shader_Desc {
    desc: sg.Shader_Desc
    desc.label = "square_shader"
